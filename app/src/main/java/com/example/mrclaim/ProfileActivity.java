            ...
            public void onClick(View v) {
                ...
                reference.child(FirebaseAuth.getInstance().getUid()).setValue(Profile_model).addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(ProfileActivity.this, "Data Inserted Successfully!", Toast.LENGTH_SHORT).show();

                    }
                }).addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(ProfileActivity.this, "Data Inserted Failed!", Toast.LENGTH_SHORT).show();
        ...
        fileRef.putFile(imageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                fileRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(ProfileActivity.this,"Image Not Retive !",Toast.LENGTH_SHORT).show();
                    }
                });
            ...
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(ProfileActivity.this,"Image Uploaded is Failed",Toast.LENGTH_SHORT).show();
            }
        });
